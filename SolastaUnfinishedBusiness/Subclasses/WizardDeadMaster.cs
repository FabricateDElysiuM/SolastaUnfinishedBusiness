                    ...
                    )>>
            {
                ...
                }, //CR 1
                {
                    (5, 3), new()
                    {
                        ...
                        (Ghast, 1, Sprites.SpellRaiseGhoul, new BaseDefinition[] { MonsterAttackDefinitions.Attack_Wildshape_GiantEagle_Talons, MonsterAttackDefinitions.Attack_Wildshape_Wolf_Bite })
                    }
                }, //CR 2
                {
                    (7, 4), new()
                    {
                        ...
                        (Skeleton_Sorcerer, 1, Sprites.SpellRaiseWight, new BaseDefinition[] { Quarterstaff })
                    }
                }, //CR 3
                {
                    (9, 5),
                    new() { (Wraith, 1, Sprites.SpellRaiseGhost, new BaseDefinition[] { Enchanted_Dagger_Souldrinker }),
                            (Brood_of_flesh, 1, Sprites.SpellRaiseSkeleton, new BaseDefinition[] { MonsterAttackDefinitions.Attack_Wildshape_GiantEagle_Talons, MonsterAttackDefinitions.Attack_Wildshape_Wolf_Bite }) }
                }, //CR 4
                {
                    (11, 6), new()
                    {
